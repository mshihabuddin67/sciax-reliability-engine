...
Confidence scores are heuristic estimates generated by the current lightweight inference engine and may evolve with future calibration, benchmarking, and semantic analysis improvements.

Current scores reflect real API outputs from the existing S-CIAX inference pipeline.
